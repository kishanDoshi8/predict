...
import { fmtPts, signedPts } from "@/features/duel-details/lib/duelDetailUtils";
...
>
{isLeavingQueue ? <Spinner /> : <Ban className='size-4' />}
Leave Queue
</Button>
) : (
<Button
...
disabled={!eligible || isJoining || isCurrentUserChallenger}
>
{isJoining ? <Spinner /> : <Swords className='size-4' />}
